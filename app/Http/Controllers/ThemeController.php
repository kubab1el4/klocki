...
class ThemeController extends Controller {
    ...
    public function showSets(string $id) {
        return SetResource::collection(LEGOTheme::findOrFail($id)->getRecursiveSets()->toQuery()->sortFields('year')->filter()->sort()->paginate(15));
    }
    ...
    public function getChildren(string $id) {
        return ThemeResource::collection(LEGOTheme::findOrFail($id)->children()->paginate(15));
    }
}
